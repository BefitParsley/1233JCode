#include "vex.h"
#include "catapultConfig.h"
#include "intakeConfig.h"
...
//Left Motors:
motor_group(UpR,BackR,FrontR),

//Right Motors:
motor_group(UpL,BackL,FrontL),
...
void pre_auton(void) {
  ...
  while(auto_started == false){            //Changing the names below will only change their names on the
    ...
    switch(current_auton_selection){       //Tap the brain screen to cycle through autons.
      case 0:
        Brain.Screen.printAt(50, 50, "matchload_side");
        break;
      case 1:
        Brain.Screen.printAt(50, 50, "defense_side");
        break;
      case 2:
...
void autonomous(void) {
  ...
  switch(current_auton_selection){  
    case 0:
      matchload_side(); //This is the default auton, if you don't select from the brain.
